//#region src/lib/code/svelteDeviantartLink.ts
var svelteDeviantartLink_default = {
...
function loadImagesForGallery() {
	return ImageData;
}
function loadImagesForGalleryByTag(tagFilter) {
	return loadImagesForGallery().filter((img) => img.tags.includes(tagFilter.toLocaleLowerCase()));
}
function loadImagesForDisplay(imageIndex) {
...
function getTagStringConversion(str) {
	return getImageTagList().find((e) => e.tag == str);
}
//#endregion
export { svelteDeviantartLink_default as t };
